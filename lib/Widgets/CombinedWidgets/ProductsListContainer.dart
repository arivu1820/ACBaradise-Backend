...
import 'package:acbaradise/Widgets/SingleWidgets/ProductACContain.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Container(
        ...
        child: Row(
          children: [
            ProductACContainer(imageUrl: imageUrl),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ProductCartBtn(img: imageUrl, title: productName, uid: uid, productid: productid,stock: stock,)
                ],
              ),
            )
          ],
